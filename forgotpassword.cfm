...
<div id="container">
 ...
 <tr>
  ...
  <div id="mainContent">
	...
	<form id="Login" action="forgotpassword.cfm" method="post" name="Login">
    <table cellspacing="0" cellpadding="0" width="371" align="center" border="0">
        <tr>
          <td colspan="3"><div align="center"><strong><span class="style4">
            Enter Email Address Below And Your Password Will Be Sent To You Promptly 
          </span></strong></div></td>
        </tr>
        <tr>
          <td width="109"><div align="right"><span class="vocab style4">Email:</span></div></td>
          <td width="155"><input id="Email" name="Email" type="text" /></td>
          <td width="107">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
...
<cfquery name="getpassword" datasource="LessonPlansDB">
SELECT lastname, firstname, Password, Email FROM registration WHERE Email = '#Form.email#'
</cfquery>
<cfif getpassword.RecordCount NEQ 0>
<CFMAIL FROM="noreply@u-46.org" TO="#Form.email#" SUBJECT="Your password to login into www.americanhistorypartnership.org\login.cfm">
Dear #getpassword.FirstName# #getpassword.LastName#,

	Your password for the site www.americanhistorypartnership.org\login.cfm is as follows:
	#getpassword.password#
	Feel free to go to www.americanhistorypartnership.org to submit a new lesson plan or view those already submitted.

	-This message was sent as a courtesy of the americanhistorypartnership.org website administration
</CFMAIL>
<cfoutput>Your password has been sent to #Form.email#</cfoutput>
<cfelse>
Sorry, your email does not exist in the profile database
</cfif>
</cfif></div></td>
          </tr>
    </table>
